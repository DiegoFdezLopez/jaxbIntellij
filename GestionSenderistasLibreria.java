...
public class GestionSenderistasLibreria {
    /**
     ...
     */
    private File archivoXML = new File("src/main/resources/gestionSenderistasData.xml");

    /**
     * Constructor sin parametros
     */
    public GestionSenderistasLibreria() {
        super();
    }
    ...
    public boolean eliminarParticipante(TipoActividad actividad, String idSenderista) {
        ...
        List<String> lista = actividad.getParticipantes().getIdSenderista();
        // REMOVE DEVUELVE TRUE SI BORRA, FALSE SI NO ESTABA
